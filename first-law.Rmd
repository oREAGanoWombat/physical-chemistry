...
$$\Delta H_{rxn}= \sum_{products }\upsilon \cdot \Delta H_f^o - \sum_{reactants} \upsilon \cdot \Delta H_f^o$$
  where $\upsilon$ is the stoichiometric coefficient of a species in the balanced chemical reaction
